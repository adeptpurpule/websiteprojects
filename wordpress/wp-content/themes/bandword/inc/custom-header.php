...
function twentyfifteen_header_background_color_css() {
	...
	wp_add_inline_style( 'bandtheme-style', sprintf( $css, $header_background_color ) );
}
...
function twentyfifteen_sidebar_text_color_css() {
	...
	wp_add_inline_style( 'bandtheme-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
